                    ...
                    <div className="SingleProduct_Container">
                        <div className="SingleProduct_Content_Container">
                            ...
                            <div className="SingleProduct_Info_Container">
                                ...
                                <span className="SP_RatingStar_Txt">
                                    Rating:
                                </span>
                        ...
                        <div className="SingleProduct_BuyBox_Container">
                            <div className="BuyBox_Container">
                                ...
                                <div className="BuyBox_PrimaryMessage">
                                    ...
                                    <div className="BuyBox_EST">
                                        Tuesday, May 23
                                    </div>
                                </div>
                                <span className="BuyBox_Country">
                                    <PlaceOutlinedIcon className="BuyBox_LocationIcon" />
                                    <span className="BuyBox_Country_Txt">
                                        Pakistan
                                    </span>
                                </span>
                                {SingleProduct?.stock > 0 ? (
                                    <div className="BuyBox_InStock">
                                        In Stock
                                    </div>
                                ) : (
                                    <div className="BuyBox_OutOfStock">
                                        Out Of Stock
                                    </div>
                                )}
                                <div className="BuyBox_Quantity">
                                    <form className="BuyBox_Quantity_Info_Form">
                                        ...
                                        >
                                            <option
                                                value="1"
                                                className="Quantity_Option Bg_Other2"
                                            >
                                                1
                                            </option>
                                            <option
                            ...
                            <div className="BuyBox_SellOn text-center">
                                <p className="HOTS_Txt mb-0">
                                    Have one to sell?
                                </p>
                                <Link className="BuyBox_SellOnAmazon_Link">
                                    Sell On E-Shop
                                </Link>
                            </div>
                        </div>
